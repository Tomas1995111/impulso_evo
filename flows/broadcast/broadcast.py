...
mensajes_semana = [
    ...
    {"dias": ["mon", "tue", "wed", "thu", "fri"], "hora": "13:00", "mensaje": "alerta_bursatil", "grupo": [config.REVISION]},
    {"dias": ["mon", "tue", "wed", "thu", "fri"], "hora": "13:00", "mensaje": "alerta_bursatil", "grupo": [config.REVISION]},
    {"dias": ["mon", "tue", "wed", "thu", "fri"], "hora": "13:00", "mensaje": "alerta_bursatil_arg", "grupo": [config.REVISION]},
    {"dias": ["mon", "tue", "wed", "thu", "fri"], "hora": "13:00", "mensaje": "alerta_bursatil_arg", "grupo": [config.REVISION]},
